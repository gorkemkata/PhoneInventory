...
<div id="container">
 ...
 <hr/>
  <h2 style="text-align:center;">You successfully reserved this phone</h2>
  <br/>
  ...
  <div class="table_container">  
   ...
   <div class="phone_image" > <a href="PhoneInventory">
    <img src="${imageUri}" width="72" height="49" border="0" style="padding-bottom:0.5em;" alt="image not found" /></a> ${oldPhone.model}
    </div> 
  ...
  <td>	
  <input class="info_box" type="text" name="ipAddress" value="${newPhone.ip}"/>
  </td>	
  
  <td>	
  <input class="info_box" type="text" name="mac" value="${newPhone.mac}"/>	
  </td>	
  
  <td>
  <input class="info_box" type="text" name="software" value="${newPhone.software}"/>
  </td>
  ...
  <input class="info_box" type="text" name="reserver" value="${newPhone.reserver}" />
   ...
   <button type="submit"class="button" id="update_phone" name="update_phone" value="true" >Update </button>
   </div>
